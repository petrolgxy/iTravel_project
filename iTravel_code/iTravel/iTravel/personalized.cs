...
namespace iTravel
{
    ...
    {
        string name, engname, location, telenum, introduction, time;
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            dbconn = new OleDbConnection(@"provider=microsoft.jet.oledb.4.0; Data Source=C:\Users\Administrator\Desktop\personalised_attractions.mdb");
            dbconn.Open();
